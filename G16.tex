...
\title{\vspace{-2.5cm}\includegraphics[width=.15\textwidth]{DTU}\lb\vspace{.5em}\Huge\scshape\color{DTUred} \titl\lb\vspace{-4mm}\rule{4cm}{0.5mm}\lb\Large{\courseno \ \course}}
...
\input{sections/01Introduktion.tex}
\input{sections/02Design.tex}
\input{sections/03Implementation.tex}
\input{sections/04Test.tex}
\input{sections/05ProjectManagement.tex}
