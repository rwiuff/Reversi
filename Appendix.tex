...
\begin{table}[H]
    ...
    \begin{tabular}{ll}
        ...
        \midrule
        Rasmus Wiuff    & \cref{sec:introtilg,sec:speci,sec:boardImplement,sec:unitTests,sec:pm,tbl:boardfields,tbl:boardmethods,tbl:hashmaps,fig:directions,fig:findOwn,fig:gantt} \\
        \bottomrule
    \end{tabular}
\end{table}