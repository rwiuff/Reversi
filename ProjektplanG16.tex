...
\subsection{Model}
En klasse som indeholder et \emph{bræt}-objekt med tilhørende logik for kontrol af spil-tilstande og lovlighed af brikkers placering/vending. Brættet er et heltals array med tilstande for tom, hvid og sort.
