...
Hele projektet (inklusiv denne rapport) er tilgængeligt online på \href{https://github.com/rwiuff/Reversi}{\color{DTUred}Github} \github{https://github.com/rwiuff/Reversi}. I mappestrukturen er \emph{``BasicReversi''} og \emph{``AdvancedReversi''} rodmapper for hver deres projekt som kan importeres i Eclipse og Visual Studio Code. Læs mere i \cref{sec:GGG}.
...
\subsection{Specifikationer}\label{sec:speci}
...
\subsection{Målsætninger}\label{MS}
