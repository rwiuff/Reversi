...
I starten af projektet var jeg lidt bekymret for, hvordan vi skulle lave dette projekt. Jeg har ikke rigtig arbejdet på et stort projekt i dette omfang før, bla. fordi der har været nogle nye værktøjer og funktioner i spil, som LaTex, JavaFX, git,Gradle og SceneBuilder. Men i slutningen af projektet lærte jeg meget om disse værktøjer, og det vigtigste er at jeg styrket mit arbejde som et team, og lært meget mere om hvordan man kan behandle de stor fejl som man møder i sådan et projekt og være mere tålmåle med at analyser dem indtil man finder en løsning.
