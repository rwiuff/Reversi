...
\subsubsection{Basic og Advanced Reversi}
Arbejdsfordeling har været anderledes mellem Basic Reversi og Advanced Reversi, hvor vi i den Basic inddelt projekts opgaver i makkerpar som er beskrevet ovenfor i afsnit 5.2. 
Vi kommunikerede løbende med hinanden om de forskellige metoder som vi hver i sig har sat fokus på, så vi alle har dette samme billede om hvordan vi vil kombinere dem sammen.
