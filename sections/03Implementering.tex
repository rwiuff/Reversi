...
\begin{table}[H]
    ...
    \begin{tabular}{lll}
        ...
        \mintinline{java}|firstFour(int row, int column, Pane pane)| &                                     & Spilleren kan sætte de første fire brikker           \\
        ...
        \mintinline{java}|getRowIndex(MouseEvent event)|             &                                     & Returnerer rækkeindekset for pane't, der klikkes på. \\
        \mintinline{java}|getColumnIndex(MouseEvent event)|          &                                     & Returnerer søjleindekset for pane't, der klikkes på. \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{lll}
        ...
        \mintinline{java}|saveHighScore(int score,String name)| &                                    & Gemmer vinderens score og navnet adskilt af               \\
